              ...
              <div className="rounded-2xl bg-gray-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm/6 text-gray-600">
                  <div>
                    ...
                    <dd>
                      <a href="mailto:collaborate@example.com" className="font-semibold text-[#009688]">
              ...
              <div className="rounded-2xl bg-gray-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm/6 text-gray-600">
                  <div>
                    <dt className="sr-only">Email</dt>
                    <dd>
                      <a href="mailto:press@example.com" className="font-semibold text-[#009688]">
                        press@example.com
                      </a>
                    </dd>
                  </div>
              ...
              <div className="rounded-2xl bg-gray-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm/6 text-gray-600">
                  <div>
                    <dt className="sr-only">Email</dt>
                    <dd>
                      <a href="mailto:careers@example.com" className="font-semibold text-[#009688]">
                        careers@example.com
                      </a>
                    </dd>
                  </div>
              ...
              <div className="rounded-2xl bg-gray-50 p-10">
                ...
                <dl className="mt-3 space-y-1 text-sm/6 text-gray-600">
                  <div>
                    <dt className="sr-only">Email</dt>
                    <dd>
                      <a href="mailto:hello@example.com" className="font-semibold text-[#009688]">
                        hello@example.com
                      </a>
                    </dd>
                  </div>
